...
Action = Literal[
    ...
    "cursor_position",
    # minecraft
    "hold_down_left_button",
    "release_left_button",
    "hold_down_arrow_up",
    "release_arrow_up",
    "hold_down_arrow_down",
    "release_arrow_down",
    "hold_down_arrow_left",
    "release_arrow_left",
    "hold_down_arrow_right",
    "release_arrow_right",
]
...
class ComputerTool(BaseAnthropicTool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        elif action == "hold_down_arrow_left":
        ...
        elif action == "hold_down_arrow_right":
    ...
    async def screenshot(self):
        ...
        screenshot_cmd = f"{self._display_prefix}screencapture -f {path} -p"
